// zett42 PlasmaFractal module.
// Returns source of GLSL noise functions which are created by Brian Sharpe. 
...
(function(){
	...
	const module = self.z42glNoise = {};

    //  Perlin Noise 3D shader function
    //  Return value range of -1.0->1.0
    //  https://github.com/BrianSharpe/Wombat/blob/master/Perlin3D.glsl
    //
    module.perlin3D = function(){ return glsl`
        float noise( vec3 P ) {
    ...
    //
    module.cellular3D = function(){ return glsl`
        float noise( vec3 P ) {
            //	establish our grid cell and unit position
            vec3 Pi = floor(P);
            vec3 Pf = P - Pi;
    ...
    //
    module.value3D = function(){ return glsl`
        float noise( vec3 P ) {
            // establish our grid cell and unit position
            vec3 Pi = floor(P);
            vec3 Pf = P - Pi;
